...
const Delivery = () => {
  return (
    <div className='w-full bg-white py-16 px-4'>
        ...
        <div className='max-w-[1520px] grid md:grid-cols-2 '>
            <img className='w-[550px] my-4' src='https://res.cloudinary.com/ehizeex-shop/image/upload/v1672676822/NetflixApp/FC_two_phones.6ec9a842f905769677f9_m91off.webp' alt="for sell" />
            <div className='flex flex-col justify-center'>
                <p className='text-[#00df9a] font-bold'>Get the App</p>
                <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>Limitless Convenience on-demand</h1>
                <p className='pr-5 '>Lorem ipsum dolor sit amet                               consectetur                   adipisicing       elit. Voluptatum
                  ...
                  <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto m:mx-0 py-3'>Get Started</button>
            </div>
        </div>
    </div>
  )
